...
class BobDemo  {
    ...
    const DB_HOST = DB_SERVE;
    const DB_NAM = DB_NAME;
    const DB_USE = DB_USER;
    ...
    public function __construct() {
        ...
        $conStr = sprintf("mysql:host=%s;dbname=%s;charset=utf8", self::DB_HOST, self::DB_NAM);

        try {
            $this->pdo = new PDO($conStr, self::DB_USE, self::DB_PASSWORD);
            //for prior PHP 5.3.6
